...
<div class="dmtm unique" style="display:none;">
    <div class="pp pp11">
        ...
        <input type="button" value="06" action="dt_d" max="2" class="code s max" />
        <input type="button" value="07" action="dt_d" max="2" class="code d max" />
        <input type="button" value="08" action="dt_d" max="2" class="code s max" />
        <input type="button" value="09" action="dt_d" max="2" class="code d max" />
        <input type="button" value="10" action="dt_d" max="2" class="code s max" />
