...
<div class="dmtm unique" style="display:none;">
    <div class="pp pp11">
        ...
        <input type="button" value="01" action="dt_d" max="2" class="code d min" />
        <input type="button" value="02" action="dt_d" max="2" class="code s min" />
        <input type="button" value="03" action="dt_d" max="2" class="code d min" />
        <input type="button" value="04" action="dt_d" max="2" class="code s min" />
        <input type="button" value="05" action="dt_d" max="2" class="code d min" />
        <input type="button" value="06" action="dt_d" max="2" class="code s min" />
        <input type="button" value="07" action="dt_d" max="2" class="code d min" />
        <input type="button" value="08" action="dt_d" max="2" class="code s min" />
        <input type="button" value="09" action="dt_d" max="2" class="code d min" />
        <input type="button" value="10" action="dt_d" max="2" class="code s min" />
        <input type="button" value="11" action="dt_d" max="2" class="code d max" />
        <input type="button" value="12" action="dt_d" max="2" class="code s max" />
        <input type="button" value="13" action="dt_d" max="2" class="code d max" />
        <input type="button" value="14" action="dt_d" max="2" class="code s max" />
        <input type="button" value="15" action="dt_d" max="2" class="code d max" />
        <input type="button" value="16" action="dt_d" max="2" class="code s max" />
        <input type="button" value="17" action="dt_d" max="2" class="code d max" />
        <input type="button" value="18" action="dt_d" max="2" class="code s max" />
        <input type="button" value="19" action="dt_d" max="2" class="code d max" />
        <input type="button" value="20" action="dt_d" max="2" class="code s max" />
    </div>
    <div class="pp pp11">
