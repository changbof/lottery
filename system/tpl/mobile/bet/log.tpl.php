<div id="bet-log-dom" class="common">
    ...
    <div class="head">
        ...
        <form action="/bet/log_search" class="search" data-ispage="true" container="#bet-log-dom .body" target="ajax" func="form_submit">
			...
			<button type="submit" class="btn btn-brown icon-search"> </button>
		</form>
        </div>
	</div>
	<div class="body" id="bet_log_body"><?php require(TPL.'/bet/log_body.tpl.php');?></div>
    <div class="tips"><small>注：“开奖号码”列 灰色--已撤单 绿色-未开奖 红色-已派奖 黑色-未中奖</small></div>
</div>
