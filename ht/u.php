...
<title>PHP探针-UPUPW环境集成包PHP套件专用版</title>
<meta name="keywords" content="PHP探针,PHP组件,PHP套件,UPUPW,UPUPW集成包,apache php,memcache,APC,SendMail" />
<meta name="description" content="UPUPW环境集成包PHP套件专用版PHP探针可检测memcache,APC,SendMail等PHP组件." />
...
<table class="info tablex2">
  ...
  <tr>
    <td class="er">Pthreads多线程组件</td>
    <td class="fl"><?=phpversion('Pthreads') ? YES : NO ?></td>
  </tr>
  <tr>
    <td class="er">APC代码缓存加速器</td>
    <td class="fl"><?=phpversion('APC') ? YES : NO ?></td>
  </tr>
  <tr>
    <td class="er">Memcache缓存组件</td>
