...
<?php 
			$sql="select sum(coin) from {$this->prename}coin_log where uid=? and liqType in(50,51,52,53,56) and actionTime between $fromTime and $toTime";
			if($data){
