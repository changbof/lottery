   ...
   <?php }else{ ?>
	...
	<tr>
    	<td colspan="8" style="text-align:left; padding-left:10px;">
           ...
           <a href="/index.php/About/deletedaili" dataType="json" class="removeAllRecord" onajax="receiverecordBeforeDelete" call="receivedeleteBet" target="ajax"><input name="delall" type="button" value="删 除" /></a>
		</td>
    </tr>
</tbody> 
</table>
