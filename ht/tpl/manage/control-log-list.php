<?php
	...
	$sql="select l.*, u.username from {$this->prename}admin_log l, {$this->prename}admin_members u where l.uid=u.uid $timeWhere $typeWhere $userWhere $ipWhere order by l.id desc";
