...
<input type="hidden" value="<?=$this->user['username']?>" />
    <header>
    	<h3 class="tabs_involved">夺宝记录
            <div class="submit_link wz">
            	<form action="/index.php/dbqb/pointList" target="ajax" call="defaultSearch" dataType="html">
	...
	<tbody> 
		...
		<tr> 
			...
			<td><a href="/index.php/dbqb/dbqbpointDel/<?=$var['id']?>" method="post" target="ajax" call="pointHandle" title="在当天时间段内删除记录将导致用户可以重复夺宝,尽量避免删除当天的记录，是否继续删除？" dataType="json">删除</a></td> 
		</tr>
		<?php }else{ ?>
			<tr>
