<?php
	...
	$sql="select s.*,u.username userName from {$this->prename}dzp_swap s, {$this->prename}members u where s.uid=u.uid $userWhere $typeWhere $timeWhere order by s.swapTime desc";
	//echo $sql;
