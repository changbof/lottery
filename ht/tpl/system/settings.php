...
<input type="hidden" value="<?=$this->user['username']?>" />
	...
	<table class="tablesorter left" cellspacing="0" width="100%">
		...
		<tbody>
			...
			<tr>
				<td>赠送活动</td>
				<td>首次设置银行账户送<input class="textWid1" type="text" value="<?=$this->settings['huoDongRegister']?>" name="huoDongRegister"/>元 &nbsp;&nbsp;每天签到每次送<input type="text" class="textWid1" value="<?=$this->settings['huoDongSign']?>" name="huoDongSign"/>元，如果为0则关闭活动</td>
			</tr>
			<tr>
				<td>充值赠送 活动</td>
                <td>
			...
			<tr>
				<td>
				<p>每天消费达<input class="textWid1" type="text" value="<?=$this->settings['conCommissionBase2']?>" name="conCommissionBase2"/>元时，上家送<input  class="textWid1"type="text" value="<?=$this->settings['conCommissionParentAmount3']?>" name="conCommissionParentAmount3"/>元佣金，上上家送<input  class="textWid1"type="text" value="<?=$this->settings['conCommissionParentAmount4']?>" name="conCommissionParentAmount4"/>元佣金，如果为0则关闭活动</p>
					</p>
				</td>
			</tr>
			...
			<tr>
				<td>
				<p>每天亏损达<input class="textWid1" type="text" value="<?=$this->settings['lossCommissionBase2']?>" name="lossCommissionBase2"/>元时，上家送<input  class="textWid1"type="text" value="<?=$this->settings['lossCommissionParentAmount3']?>" name="lossCommissionParentAmount3"/>元佣金，上上家送<input  class="textWid1"type="text" value="<?=$this->settings['lossCommissionParentAmount4']?>" name="lossCommissionParentAmount4"/>元佣金，如果为0则关闭活动</p>
					</p>
				</td>
			</tr>
			<tr>
				...
				<td>
					<p>
						返点比例为：
						<input name="bonusScale_fandian1_min" class="textWid1" type="text" value="<?=$this->settings['bonusScale_fandian1_min']?>"/>%&nbsp;~&nbsp;
						<input name="bonusScale_fandian1_max" class="textWid1" type="text" value="<?=$this->settings['bonusScale_fandian1_max']?>"/>%&nbsp;~&nbsp;
						时，账户分红比例为：<input name="bonusScale1" class="textWid1" type="text" value="<?=$this->settings['bonusScale1']?>"/>%
					</p>
					<p>
						返点比例为：
						<input name="bonusScale_fandian2_min" class="textWid1" type="text" value="<?=$this->settings['bonusScale_fandian2_min']?>"/>%&nbsp;~&nbsp;
						<input name="bonusScale_fandian2_max" class="textWid1" type="text" value="<?=$this->settings['bonusScale_fandian2_max']?>"/>%&nbsp;~&nbsp;
						时，账户分红比例为：<input name="bonusScale2" class="textWid1" type="text" value="<?=$this->settings['bonusScale2']?>"/>%
					</p>
					<p>其他返点比例不分红</p>
				</td>
			</tr>
			...
			<tr>
				<td>非推广注册用户默认返点比例</td>
				<td>
					<input type="text" class="textWid1" value="<?=$this->settings['defaultFandian']?>" name="defaultFandian"/>%,设置为0则为关闭非推广注册
				</td>
			</tr>
		</tbody>
	</table>
