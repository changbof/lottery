...
<?php
    ...
    <tr> 
        ...
        <td><a href="/index.php/box/allmidinfo/<?=$var['mid']?>" button="" title="消息内容" width="510" modal="true" target="modal"><?=$var['mid']?></a></td> 
...
<?php }else{ ?>
    ...
    <tr>
    	<td colspan="6" style="text-align:left; padding-left:10px;">
           ...
           <a href="/index.php/box/alldeleteall/" dataType="json" class="removeAllRecord" onajax="alllistrecordBeforeDelete" call="alllistdeleteBet" target="ajax"><input name="delall" type="button" value="永久删除" /></a>
		</td>
    </tr>
</tbody> 
</table>
