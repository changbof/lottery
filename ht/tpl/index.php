...
<header id="header">
    <hgroup>
        <h1 class="site_title">乐彩娱乐平台管理后台</h1>
        <h2 class="section_title"><a class="tjgk bq load" href="business/betLog">普通投注</a><a class="tjgk bq load"
                                                                                            href="member/index">用户列表</a><a
                class="tjgk bq load" onclick="rechargModal()" value="充值">账号充值</a><a class="tjgk bq load" href="#"
                                                                                    onclick="sysAddBox()">发布消息</a><a
                class="tjgk bq load" method="post" target="ajax" call="clearDataSuccess" title="即将清空程序缓存，是否继续！"
...
<aside id="sidebar" class="column">
    ...
    <ul class="toggle" style="display:none;">
        <li><a href="countData/betDates" class="s_b_2 bq">分红统计</a></li>
    ...
    <footer>
        <hr/>
        <p><strong>Copyright &copy; 乐彩娱乐平台管理系统</strong></p>
    </footer>
