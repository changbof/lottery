<article class="module width_full">
	...
	<article class="stats_graph" style="margin:10px;">
		<img src="" width="400" height="140" alt="" />
	</article>
...
<article class="module width_full">
	...
	<tbody> 
		<tr> 
			...
			<td><?=$this->getValue("select count(distinct uid) from {$this->prename}member_session where isOnLine=1 and accessTime>{$this->time}-900 and uid in (select uid from {$this->prename}members)")?></td> 
