<?php
	...
	$all['brokerageAmount']=$this->getValue("select sum(l.coin) from {$this->prename}coin_log l, {$this->prename}members u where l.liqType in(50,51,52,53,54,56,150,140,130,120,110) and l.uid=u.uid $brokerageTimeWhere $userWhere3", $var['uid']);
