...
<input type="hidden" value="<?=$this->user['username']?>" />
    <header>
    	<h3 class="tabs_involved">提款记录
            <div class="submit_link wz">
            	<form action="/index.php/dzyh/tkpointList" target="ajax" call="defaultSearch" dataType="html">
	...
	<tbody> 
		...
		<tr> 
			...
			<td><a href="/index.php/dzyh/dzyhpointDel/<?=$var['id']?>" method="post" width="400" class="myanswer" target="ajax" title="是否删除该笔提款记录?" modal="true" call="pointHandle" dataType="json">删除</a>
		</tr>
		<?php }else{ ?>
			<tr>
