...
<input type="hidden" value="<?=$this->user['username']?>" />
	...
	<form name="system_install" action="/index.php/Dzyh/updateSettings" method="post" target="ajax" call="dzyhSettings" onajax="dzyhSettingsBefor">
	<table class="tablesorter left" cellspacing="0" width="100%">
		...
		<tbody>
			...
			<tr>
				<td>存款</td>
				<td>
					<input type="text" class="textWid1" value="<?=$this->dzyhsettings['ckdate1']?>" name="ckdate1"/>&nbsp日，日利息为&nbsp<input type="text" class="textWid1" value="<?=$this->dzyhsettings['cklv1']?>" name="cklv1"/>&nbsp%，例如，存款&nbsp<input type="text" class="textWid1" value="<?=$this->dzyhsettings['ckeg1']?>" name="ckeg1"/>&nbsp元，那么&nbsp<?=$this->dzyhsettings['ckdate1']?>&nbsp天后提出，可得到利息<?=$this->dzyhsettings['ckeg1']*$this->dzyhsettings['cklv1']/100?>*<?=$this->dzyhsettings['ckdate1']?>=<?=$this->dzyhsettings['ckeg1']*$this->dzyhsettings['cklv1']/100*$this->dzyhsettings['ckdate1']?>元。
				</td>
			</tr>
			<tr>
				<td>存款</td>
				<td>
					<input type="text" class="textWid1" value="<?=$this->dzyhsettings['ckdate2']?>" name="ckdate2"/>&nbsp日，日利息为&nbsp<input type="text" class="textWid1" value="<?=$this->dzyhsettings['cklv2']?>" name="cklv2"/>&nbsp%，例如，存款&nbsp<input type="text" class="textWid1" value="<?=$this->dzyhsettings['ckeg2']?>" name="ckeg2"/>&nbsp元，那么&nbsp<?=$this->dzyhsettings['ckdate2']?>&nbsp天后提出，可得到利息<?=$this->dzyhsettings['ckeg2']*$this->dzyhsettings['cklv2']/100?>*<?=$this->dzyhsettings['ckdate2']?>=<?=$this->dzyhsettings['ckeg2']*$this->dzyhsettings['cklv2']/100*$this->dzyhsettings['ckdate2']?>元。
				</td>
			</tr>
			<tr>
				<td>存款</td>
				<td>
					<input type="text" class="textWid1" value="<?=$this->dzyhsettings['ckdate3']?>" name="ckdate3"/>&nbsp日，日利息为&nbsp<input type="text" class="textWid1" value="<?=$this->dzyhsettings['cklv3']?>" name="cklv3"/>&nbsp%，例如，存款&nbsp<input type="text" class="textWid1" value="<?=$this->dzyhsettings['ckeg3']?>" name="ckeg3"/>&nbsp元，那么&nbsp<?=$this->dzyhsettings['ckdate3']?>&nbsp天后提出，可得到利息<?=$this->dzyhsettings['ckeg3']*$this->dzyhsettings['cklv3']/100?>*<?=$this->dzyhsettings['ckdate3']?>=<?=$this->dzyhsettings['ckeg3']*$this->dzyhsettings['cklv3']/100*$this->dzyhsettings['ckdate3']?>元。
				</td>
			</tr>
			<tr>
				<td>存款</td>
